package com.ahmed.fingerspeedgame;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void restoreTheGame() {
        ...
        countDownTimer = new CountDownTimer((long)remainingTime * 1000, timerInterval) {
            ...
            public void onFinish() {
                ...
                showAlert("You Lost!", "Would you like to reset the game?");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.info_item) {
            ...
            showToast("This is the Current Version of your Game. Check out Google Play and Make sure that you're playing the latest version of the game" , Toast.LENGTH_LONG);
